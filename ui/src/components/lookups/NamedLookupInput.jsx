...
function syncEditorContent(root, segments, options = {}) {
  ...
  for (const segment of segments) {
    ...
    if (editingChip && editingChip.raw === segment.raw) {
      ...
      button.tabIndex = -1;
      button.style.border = '1px solid #0f6b43';
      button.style.background = 'linear-gradient(180deg, #187a4f 0%, #0f633d 100%)';
    ...
    chip.tabIndex = -1;
    chip.className = `forge-lookup-chip${segment.unresolved ? ' is-unresolved' : ''}`;
