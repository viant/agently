...
import (
	...
	convapi "github.com/viant/agently/client/conversation"
...
func New(ctx context.Context, dao *datly.Service) (convapi.API, error) {
	return internal.New(ctx, dao)
}

// NewFromEnv constructs a datly service from environment and returns the conversation API.
func NewFromEnv(ctx context.Context) (convapi.API, error) {
