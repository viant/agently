...
func main() {
	...
	//os.Args = []string{"", "chat", "-q=how many table in my ci_ads db?", "-c=351451ae-3e0b-6d47-89e6-6c32e42edb18"}
	os.Args = []string{"", "chat", "-q=plan trip to my favourite city?", "-c=92115111-2e0b-6d47-49e6-6c32e42eda11"}
