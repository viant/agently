	...
	cases := []testCase{
		{
			...
			seed: []dbtest.ParameterizedSQL{
				...
				{SQL: "INSERT INTO turns (id, conversation_id, status) VALUES (?,?,?)", Params: []interface{}{"t1", "c1", "running"}},
				{SQL: "INSERT INTO turns (id, conversation_id, status) VALUES (?,?,?)", Params: []interface{}{"t2", "c1", "failed"}},
			},
		...
		},
		{
			...
			seed: []dbtest.ParameterizedSQL{
				{SQL: "INSERT INTO conversation (id, summary) VALUES (?,?)", Params: []interface{}{"c1", "A"}},
				{SQL: "INSERT INTO turns (id, conversation_id, status, created_at) VALUES (?,?,?,?)", Params: []interface{}{"t1", "c1", "running", "2024-01-01 10:00:00"}},
				{SQL: "INSERT INTO turns (id, conversation_id, status, created_at) VALUES (?,?,?,?)", Params: []interface{}{"t2", "c1", "succeeded", "2024-01-01 12:00:00"}},
				{SQL: "INSERT INTO conversation (id, summary) VALUES (?,?)", Params: []interface{}{"c2", "B"}},
				{SQL: "INSERT INTO turns (id, conversation_id, status) VALUES (?,?,?)", Params: []interface{}{"t3", "c2", "running"}},
			},
...

		{
			...
			seed: []dbtest.ParameterizedSQL{
				{SQL: "INSERT INTO conversation (id, summary) VALUES (?,?)", Params: []interface{}{"c1", "A"}},
				{SQL: "INSERT INTO turns (id, conversation_id, status, created_at) VALUES (?,?,?,?)", Params: []interface{}{"t1", "c1", "running", "2024-01-01 10:00:00"}},
				{SQL: "INSERT INTO turns (id, conversation_id, status, created_at) VALUES (?,?,?,?)", Params: []interface{}{"t2", "c1", "running", "2024-01-01 12:00:00"}},
			},
		...
		},
		{
			...
			seed: []dbtest.ParameterizedSQL{
				{SQL: "INSERT INTO conversation (id, summary) VALUES (?,?)", Params: []interface{}{"c1", "A"}},
				{SQL: "INSERT INTO turns (id, conversation_id, status) VALUES (?,?,?)", Params: []interface{}{"t1", "c1", "running"}},
				{SQL: "INSERT INTO turns (id, conversation_id, status) VALUES (?,?,?)", Params: []interface{}{"t2", "c1", "running"}},
				{SQL: "INSERT INTO turns (id, conversation_id, status) VALUES (?,?,?)", Params: []interface{}{"t3", "c1", "running"}},
			},
