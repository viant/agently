...
// WorkflowAdaptor pushes workspace YAML changes into a running Fluxor runtime
// through user-supplied callbacks so that internal/hotswap avoids importing
// the fluxor package (keeps dependency graph acyclic).
//
